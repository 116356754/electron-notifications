...
class Notifier {
    ...
    notify(title, data) {
        ...
        let windowOptions = {
            width: 440,
            height: this.notificationHeight + verticalSpace + this.stackGap, /* stack gap now supported, though not sure why the current gap would not be sufficient */
            x: size.width - 440,
